---
title: "DiOC6 MitoSox 72hr 9/25/2020"
author: "Burton"
date: "11/5/2020"
output: pdf_document
---
...
```{r}
fitcHuh <- read_tsv("72hr/dioc_huh.txt")
fitcVero <- read_tsv("72hr/dioc_vero.txt")
peHuh <- read_tsv("72hr/mito_huh.txt")
peVero <- read_tsv("72hr/mito_vero.txt")
```
...
fitcCleanedHuh <- fitcHuh %>% 
  ...
  mutate(`Sample:` = str_replace(`Sample:`, 
                                 "DIOC [0-9][0-9] hr Vero and HuH7 Covid_9-[0-9][0-9]-2020_", 
                                 ""),
